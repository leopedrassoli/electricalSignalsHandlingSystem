# -*- coding: utf-8 -*-
"""
Created on Thu Aug  2 12:36:02 2018

@author: leona
"""
import matplotlib.pyplot as plt
import matplotlib.dates as mdates
path = "C:/Users/leona/OneDrive/UFU/IC/interface/"
...
def plotSeparado(x,medicoes):
    ...
    for tipo in medicoes:        
        ...
        Layout(f1,tipo,x)
        if aux == 0:
            plt.savefig(tipo['ylabel']+formato)
        if aux == 1:
            plt.draw()
            if n == (len(medicoes)-1):
                plt.show()
